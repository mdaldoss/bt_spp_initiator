...
# ESP-IDF esp32-bt-classic-spp-multi-acceptor
This example is inspired by BT-SPP-INITATOR demo and modified to allows bluetooth SPP connection to connect simultaneously with multiple (up to 7) Bluetooth acceptor devices 
